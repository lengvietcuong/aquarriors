...
const floatVelocity = 5;

class Trash extends SpriteComponent with HasGameRef, CollisionCallbacks {
  Trash({
    required this.name,
  ...
  Future<void> onLoad() async {
    ...
    final trashImg = Flame.images.fromCache("Trash/$name.png");
    sprite = Sprite(trashImg);
