        ...
        <div className="flex-1 space-y-4 lg:space-y-6">
          <div className="flex items-center gap-3">
            ...
            <p className="lg:text-xl">
              Decades of experience in environmental cleanup
            </p>
          </div>
          <div className="flex items-center gap-3">
            <div className="size-14 md:size-12 lg:size-14 grid place-items-center bg-primary/15 border border-primary rounded-full flex-shrink-0">
            ...
            <p className="lg:text-xl">Trained and dedicated staff</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="size-14 md:size-12 lg:size-14 grid place-items-center bg-primary/15 border border-primary rounded-full flex-shrink-0">
              <ToolboxIcon className="size-7 md:size-6 lg:size-7" />
            </div>
            <p className="lg:text-xl">Specialized equipment</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-lg md:max-w-none mt-8 flex flex-col gap-4 md:mt-12 lg:mt-16 md:flex-row md:gap-4 lg:gap-8">
        <div className="flex-1">
          <Image
            ...
            alt="Automatic trash collectors"
            className="rounded-lg"
          />
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Workers collecting trash (Source:{" "}
            <a
        ...
        <div className="flex-1">
          ...
          />
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Automatic trash collectors (Source:{" "}
            <a
        ...
        <div className="flex-1">
          ...
          />
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Garbage truck disposing collected waste (Source:{" "}
            <a
