        ...
        <FormItem>
          ...
          <FormControl>
            <Input
              ...
              {...field}
              className={`${fieldState.error ? "border-destructive bg-destructive/40" : ""}`}
            />
          </FormControl>
          <FormMessage>
            {fieldState.error && (
      ...
      render={({ field, fieldState }) => (
        <FormItem>
          ...
          <FormDescription>
            ...
            {`Every $1 is ${kgTrashPerDollar}kg of trash removed.`}
          </FormDescription>
          <FormControl>
            <RadioGroup
              onValueChange={(value) => {
            ...
            >
              ...
              <FormItem className="col-span-2">
                <FormLabel
                  className={`flex min-h-20 cursor-pointer flex-col items-center justify-center rounded border-2 focus-within:border-none focus-within:bg-transparent focus-within:text-foreground focus-within:outline focus-within:outline-2 focus-within:outline-offset-2 ${fieldState.error ? "border-destructive bg-destructive/40 focus-within:bg-destructive/40" : customDonationAmount === field.value ? "border-foreground bg-foreground text-background" : "not:focus-within:hover:bg-secondary"}`}
                  onClick={() => {
        ...
        <FormItem>
          ...
          <FormControl>
            <Textarea
              ...
              {...field}
              className={`resize-none ${fieldState.error ? "border-destructive bg-destructive/40" : ""}`}
            />
          </FormControl>
          <FormMessage>
            {fieldState.error && (
      ...
      render={({ field, fieldState }) => (
        <FormItem>
          <div className="mt-2 flex flex-row items-start space-x-3 space-y-0">
            ...
            <FormLabel>I am 16 or older</FormLabel>
          </div>
          <FormMessage>
            {fieldState.error && (
              <>
    ...
    <Controller
      ...
      render={({ field }) => (
        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
          ...
          <FormLabel>Send me updates on this cleanup project</FormLabel>
        </FormItem>
      )}
    />
  );
